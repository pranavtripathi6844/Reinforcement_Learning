...
def test_sac(model_path, env_name='CustomHopper-target-v0', n_episodes=50):
    """
    Test a trained SAC model (Source or Target).
    """
...
if __name__ == "__main__":
    ...
    test_sac(args.model, args.env, args.episodes)
